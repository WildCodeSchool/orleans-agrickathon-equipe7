...
use FrontBundle\Entity\Articles;
...
class ArticlesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $articles = $em->getRepository('FrontBundle:Articles')->findAll();
    ...
    {
        $article = new Article();
        $form = $this->createForm('FrontBundle\Form\ArticlesType', $article);
    ...
    {
        $deleteForm = $this->createDeleteForm($article);
        $editForm = $this->createForm('FrontBundle\Form\ArticlesType', $article);
